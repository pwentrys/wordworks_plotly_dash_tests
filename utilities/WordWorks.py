...
class WordWorks:
    ...
    def _cleanup_dict_singular(string, key_list):
        ...
        if string.endswith('ension'):
            temp = f'{string[:-4]}t'
            if key_list.__contains__(temp):
                return temp
        if string.endswith('quel'):
            temp = f'{string[:-1]}nce'
            if key_list.__contains__(temp):
                return temp
        if string.endswith('umed'):
            temp = string[:-1]
            if key_list.__contains__(temp):
                return temp
        if string.endswith('ushy'):
            temp = string[:-1]
            if key_list.__contains__(temp):
                return temp
        if string.endswith('tising'):
            temp = string[:-5]
            if key_list.__contains__(temp):
                return temp
        if string.endswith('tised'):
            temp = string[:-4]
            if key_list.__contains__(temp):
                return temp
        ...
        if string.endswith('tted'):
            ...
            if key_list.__contains__(temp):
                return temp
        elif string.endswith('ement'):
            temp = string[:-4]
            if key_list.__contains__(temp):
                return temp
        elif string.endswith('tedly'):
            temp = string[:-4]
            if key_list.__contains__(temp):
                return temp
        ...
        if string.endswith('ly'):
            ...
            if key_list.__contains__(temp):
                return temp
        if string.endswith('ired'):
            temp = string[:-1]
            if key_list.__contains__(temp):
                return temp
        if string.endswith('ived'):
            temp = f'{string[:-2]}al'
            if key_list.__contains__(temp):
                return temp
        ...
        if string.endswith('ring'):
            ...
            if key_list.__contains__(temp):
                return temp
        if string.endswith('cing'):
            temp = f'{string[:-3]}e'
            if key_list.__contains__(temp):
                return temp
        if string.endswith('tting'):
            temp = string[:-4]
            if key_list.__contains__(temp):
                return temp
